...
internal class Program
{
    ...
    void DrawField(int[] playersMove)
        ...
        bool IsWinner(int[] playersMoves)
        {
            ...
            if (playersMoves[0] == playersMoves[3])
            {
            ...
            if (playersMoves[0] == playersMoves[4])
            {
            ...
            if (playersMoves[3] == playersMoves[4])
            {
            ...
            if (playersMoves[6] == playersMoves[7])
            {
            ...
            if (playersMoves[1] == playersMoves[4])
            {
            ...
            if (playersMoves[2] == playersMoves[5])
            {
            ...
            if (playersMoves[2] == playersMoves[4])
            {
